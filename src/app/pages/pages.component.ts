...
export class PagesComponent implements OnInit {
  ...
  updateMenu(values: any) {
    this.menu = [
      ...
      {
        title: values['car']['title'],
        open: true,
        children: [
          {
            title: values['car']['info'],
            link: '/pages/car/query',
          },
          {
            title: values['car']['type'],
            link: '/pages/car/type'
          },
          {
            title: values['car']['order'],
            link: '/pages/car/order'
          }
        ],
        link: '/pages/car',
        menuIcon: 'icon icon-b-tree',
      },
      {
        ...
        children: [
          {
            title: values['user']['info'],
            link: '/pages/user/query',
          },
          {
            title: values['user']['log'],
            link: '/pages/user/log'
          }
        ],
        link: '/pages/user',
